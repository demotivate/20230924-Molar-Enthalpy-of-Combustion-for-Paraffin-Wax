...
\begin{table}
  ...
  \resizebox{\linewidth}{!}{%
    \begin{tabular}{>{\hspace{0pt}}m{0.369\linewidth}|>{\hspace{0pt}}m{0.569\linewidth}}
      System                                                                       & Surroundings                                                                                                                     \\
      \hline
      Combustion of Paraffin Wax\par{}\(\Delta E_p\)\par{}\(q_1=nH\degree_{comb}\) & Water + Aluminium Can\par{}\(\Delta E_k\)\par{}\(q_2=m_{water}c_{water}\Delta T_{water}\)\par{}\(q_2=m_{Al}c_{Al}\Delta T_{Al}\)
    \end{tabular}
  }
